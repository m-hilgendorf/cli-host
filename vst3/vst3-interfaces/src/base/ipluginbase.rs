...
RIDL! {#[iid(0x22888DDB, 0x156E45AE, 0x8358B348, 0x08190625)]
...
RIDL! {#[iid(0x7A4D811C, 0x52114A1F, 0xAED9D2EE, 0x0B43BF9F)]
...
RIDL! {#[iid(0x0007B650, 0xF24B4C0B, 0xA464EDB9, 0xF00B2ABB)]
...
RIDL! {#[iid(0x4555A2AB, 0xC1234E57, 0x9B122910, 0x36878931)]
...
pub type GetFactoryProc = unsafe extern "C" fn() -> *mut IPluginFactory;
